model Direkte_Umsetzung_Generator_Test  
  ...
  Direkte_Umsetzung_Generator direkte_Umsetzung_Generator;
equation
  connect(step.y, direkte_Umsetzung_Generator.ML);
...
model Direkte_Umsetzung_Generator_Test_total
  extends Direkte_Umsetzung_Generator_Test;
end Direkte_Umsetzung_Generator_Test_total;
